...
public class PortalSafePortlet extends MVCPortlet {
	...
	/**
	 * Writes binary content of a item into response.
	 *
	 * @param request the portlet request
	...
	public void serveResource(
		...
		try {
			...
			Item item = PortalSafeUtil.loadItem(companyId, groupId, itemName);
	...
	private void copy(
		...
		Item item = PortalSafeUtil.loadItem(companyId, groupId, oldItemName);
	...
	private void remove(long companyId, long groupId, String itemName)
		...
		PortalSafeUtil.removeItem(companyId, groupId, itemName);
	}
