...
/**
 * Provides the base implementation for the token session local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.token.auth.service.impl.TokenSessionLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class TokenSessionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TokenSessionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.token.auth.service.TokenSessionLocalServiceUtil} to access the token session local service.
	 */
	...
	@Override
	public TokenSession addTokenSession(TokenSession tokenSession) {
		tokenSession.setNew(true);

		return tokenSessionPersistence.update(tokenSession);
	}
	 ...
	 */
	@Override
	public TokenSession createTokenSession(long sessionId) {
		return tokenSessionPersistence.create(sessionId);
	}
	...
	@Override
	public TokenSession deleteTokenSession(long sessionId)
		throws PortalException {
		return tokenSessionPersistence.remove(sessionId);
	}
	...
	public TokenSession deleteTokenSession(TokenSession tokenSession) {
		return tokenSessionPersistence.remove(tokenSession);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TokenSession.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tokenSessionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tokenSessionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TokenSession fetchTokenSession(long sessionId) {
		return tokenSessionPersistence.fetchByPrimaryKey(sessionId);
	}
	 ...
	 */
	@Override
	public TokenSession getTokenSession(long sessionId)
		throws PortalException {
		return tokenSessionPersistence.findByPrimaryKey(sessionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(com.liferay.token.auth.service.TokenSessionLocalServiceUtil.getService());
		actionableDynamicQuery.setClass(TokenSession.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return tokenSessionLocalService.deleteTokenSession((TokenSession)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return tokenSessionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TokenSession> getTokenSessions(int start, int end) {
		return tokenSessionPersistence.findAll(start, end);
	}
	...
	public int getTokenSessionsCount() {
		return tokenSessionPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.token.auth.model.TokenSession",
			tokenSessionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.token.auth.model.TokenSession");
	}
