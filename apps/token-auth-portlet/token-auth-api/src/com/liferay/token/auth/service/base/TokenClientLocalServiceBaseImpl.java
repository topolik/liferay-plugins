...
/**
 * Provides the base implementation for the token client local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.token.auth.service.impl.TokenClientLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class TokenClientLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TokenClientLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.token.auth.service.TokenClientLocalServiceUtil} to access the token client local service.
	 */
	...
	@Override
	public TokenClient addTokenClient(TokenClient tokenClient) {
		tokenClient.setNew(true);

		return tokenClientPersistence.update(tokenClient);
	}
	 ...
	 */
	@Override
	public TokenClient createTokenClient(long clientId) {
		return tokenClientPersistence.create(clientId);
	}
	...
	@Override
	public TokenClient deleteTokenClient(long clientId)
		throws PortalException {
		return tokenClientPersistence.remove(clientId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TokenClient deleteTokenClient(TokenClient tokenClient) {
		return tokenClientPersistence.remove(tokenClient);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TokenClient.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return tokenClientPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return tokenClientPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return tokenClientPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TokenClient fetchTokenClient(long clientId) {
		return tokenClientPersistence.fetchByPrimaryKey(clientId);
	}
	 ...
	 */
	@Override
	public TokenClient getTokenClient(long clientId) throws PortalException {
		return tokenClientPersistence.findByPrimaryKey(clientId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(com.liferay.token.auth.service.TokenClientLocalServiceUtil.getService());
		actionableDynamicQuery.setClass(TokenClient.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return tokenClientLocalService.deleteTokenClient((TokenClient)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return tokenClientPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TokenClient> getTokenClients(int start, int end) {
		return tokenClientPersistence.findAll(start, end);
	}
	...
	public int getTokenClientsCount() {
		return tokenClientPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TokenClient updateTokenClient(TokenClient tokenClient) {
		return tokenClientPersistence.update(tokenClient);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.liferay.token.auth.model.TokenClient",
			tokenClientLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.liferay.token.auth.model.TokenClient");
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = tokenClientPersistence.getDataSource();
