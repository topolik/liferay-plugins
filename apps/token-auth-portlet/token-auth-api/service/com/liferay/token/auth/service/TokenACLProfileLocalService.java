...
/**
 * Provides the local service interface for TokenACLProfile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TokenACLProfileLocalServiceUtil
...
public interface TokenACLProfileLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TokenACLProfileLocalServiceUtil} to access the token a c l profile local service. Add custom service methods to {@link com.liferay.token.auth.service.impl.TokenACLProfileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
